...
class Snake(arcade.Sprite):
    def __init__(self, w, h):
        ...
        self.color = arcade.color.BLACK_BEAN
        self.speed = 10
        self.width = 16
        self.height = 16
        self.center_x = w//2
...
class Apple(arcade.Sprite):
    def __init__(self, w, h):
        super().__init__("as10.snake/apple.png")
        self.width = 25
        self.height = 30
...
class Pear(arcade.Sprite):
    def __init__(self, w, h):
        super().__init__("as10.snake/pear.png")
        self.width = 35
        self.height = 35
        self.center_x = random.randint(0, w)
        self.center_y = random.randint(0, h) 
...
class Poop(arcade.Sprite):
    def __init__(self, w, h):
        super().__init__("as10.snake/poop.png")
        self.width = 35
        self.height = 35
        self.center_x = random.randint(0, w)
        self.center_y = random.randint(0, h) 
...
class Game(arcade.Window):
    ...
    def on_draw(self):
        ...
        #arcade.draw_text(350, 275, 700,550, self.background)
